...
const FEATURES = [
    ...
    { id: 'floor_heating', label: __('Fußbodenheizung', 'immobilien-rechner-pro'), iconPath: 'assets/icon/ausstattung/fussbodenheizung.svg' },
    { id: 'guest_toilet', label: __('Gäste-WC', 'immobilien-rechner-pro'), iconPath: 'assets/icon/ausstattung/wc.svg' },
    { id: 'barrier_free', label: __('Barrierefrei', 'immobilien-rechner-pro'), iconPath: 'assets/icon/ausstattung/barrierefrei.svg' },
];
