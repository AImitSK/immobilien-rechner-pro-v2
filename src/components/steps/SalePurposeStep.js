                ...
                <div className="irp-timeframe-grid">
                    {TIMEFRAMES.map((timeframe) => (
                        <motion.button
                            ...
                            whileTap={{ scale: 0.98 }}
                        >
                            <Icon path="assets/icon/zeitrahmen/zeitrahmen.svg" size={32} className="irp-timeframe-icon" />
